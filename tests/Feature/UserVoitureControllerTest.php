...
class UserVoitureControllerTest extends TestCase
{
    use RefreshDatabase;
     ...
     */
    public function test_test_voiture_index(): void
    {
        ...
        $response->assertViewIs('userCars.index');
        $response->assertViewHas('voitures');
