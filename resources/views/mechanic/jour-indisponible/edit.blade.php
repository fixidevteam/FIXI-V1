    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <div class=" px-5 py-3 text-gray-700 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <h2 class="mt-10  text-2xl font-bold leading-9 tracking-tight text-gray-900">Modifier le jour </h2>
                <form method="POST" action="{{ route('mechanic.jour-indisponible.update',$jour) }}" class="space-y-6">
                    @csrf
                    @method('PUT') 
                    <div>
