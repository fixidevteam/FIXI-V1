        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <div class=" px-5 py-3 text-gray-700 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('mechanic.operations.store') }}" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div class="shrink-0">
                        <img id='preview_img' class="h-16 w-16 object-cover rounded-full" src="{{session('temp_photo_garage_operation') ? asset('storage/'.session('temp_photo_garage_operation')) : asset('./images/defaultimage.jpg')}}" alt="Current profile photo" />
                    </div>
                    <div>
                        ...
                        @if(session('temp_photo_garage_operation'))
                        <input type="hidden" name="temp_photo_garage_operation" value="{{ session('temp_photo_garage_operation') }}">
                        @endif
