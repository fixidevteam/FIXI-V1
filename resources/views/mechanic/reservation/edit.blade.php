        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <div class=" px-5 py-3 text-gray-700 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-between items-center my-6">
                    <h2 class="text-2xl font-bold leading-9 tracking-tight text-gray-900">Modifier la date du rendez-vous</h2>
                </div>
                <div class="my-5">
                    {{-- alert --}}
                    ...
                    {{-- alert close --}}
                    <div>
                        <form method="POST" action="{{route('mechanic.reservation.update',$appointment->id)}}" class="space-y-6">
                            @csrf
                            @method('PUT')
