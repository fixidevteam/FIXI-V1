<x-mechanic-app-layout :subtitle="'Détails du véhicule'">
  <div class="p-4 sm:ml-64">
    ...
    <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
      ...
      <div class=" px-5 py-3 text-gray-700 bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="flex justify-between items-center my-6">
          <h2 class="text-2xl font-bold leading-9 tracking-tight text-gray-900">Liste des visites du véhicule</h2>
          <div class="flex items-center gap-4">
            <a href="{{ route('mechanic.operations.create') }}">
              <x-primary-button class="hidden md:block">ajouter une visite</x-primary-button>
            ...
            <div class="hidden md:block">
              <a href="{{ route('mechanic.voitures.export', ['voitureId' => $voiture->id]) }}" class="w-1/2 text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-blue-200 font-medium inline-flex items-center justify-center rounded-[20px] text-sm px-3 py-2 text-center sm:w-auto">
                ...
                Exporter les visites vers Excel
              </a>
            </div>
            @endif
          </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500">
              ...
              <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                  ...
                  <th scope="col" class="px-6 py-3">Date du visite</th>
