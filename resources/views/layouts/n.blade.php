    ...
    4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('dashboard') }}">
                            <x-application-plus-logo class="block h-9 w-auto fill-current text-gray-800" />
                        </a>
                    </div>
                    {{-- logo end --}}
                </div>
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
            <div class="flex-1 bg-white divide-y space-y-1">
                <ul class="space-y-2 font-medium pb-2">
                    ...
                    <li>
                        <a href="{{ route('documentVoiture.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group {{ Route::is('documentVoiture.index', 'documentVoiture.*') ? 'bg-gray-100 text-gray-900' : '' }}">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 {{ Route::is('documentVoiture.index', 'documentVoiture.*') ? 'text-gray-900' : '' }}" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="ms-3 first-letter:capitalize">Papiers du véhicule</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('paiperPersonnel.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group {{ Route::is('paiperPersonnel.index', 'paiperPersonnel.*') ? 'bg-gray-100 text-gray-900' : '' }}">
                            ...
                            <span class="ms-3 first-letter:capitalize">Papiers du conducteur</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('garages.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group {{ Route::is('garages.index', 'garages.*') ? 'bg-gray-100 text-gray-900' : '' }}">
                            ...
                            <span class="ms-3 first-letter:capitalize">Garages partenaires</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('paiperPersonnel.create') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
                            ...
                            <span class="ms-3 first-letter:capitalize">Ajouter un papier du conducteur</span>
                        </a>
                    </li>
                </ul>
                {{-- second list --}}
                <ul class="space-y-2 font-medium pt-2">
                    ...
                    <li>
                        <a href="{{ route('fixiPlus.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group {{ Route::is('fixiPlus.index', 'fixiPlus.*') ? 'bg-gray-100 text-gray-900' : '' }}">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 {{ Route::is('fixiPlus.index', 'fixiPlus.*') ? 'text-gray-900' : '' }}" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="ms-3 first-letter:capitalize">c'est quoi FIXI+</span>
                        </a>
                    </li>
                    <li>
