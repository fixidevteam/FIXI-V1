        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <div class=" px-5 py-3 text-gray-700 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex justify-between items-center my-6">
                    ...
                    <a href="{{route('admin.gestionCalendrier.create',$garage->id)}}">
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <a href="{{ route('admin.gestionCalendrier.edit', $schedule->id) }}" class="text-blue-500 flex items-center">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="confirmationModalCalendrier-{{ $schedule->id }}" class="fixed inset-0 bg-white bg-opacity-30 backdrop-blur-[2px] flex items-center justify-center hidden">
            <div class="bg-white rounded-lg p-6 w-96 shadow-lg">
                ...
                <div class="flex justify-end mt-4">
                    ...
                    <form action="{{ route('admin.gestionCalendrier.destroy', $schedule->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
