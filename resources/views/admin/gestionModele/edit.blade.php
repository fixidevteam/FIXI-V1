<x-admin-app-layout>
    <div class="p-4 sm:ml-64">
        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg mt-4">
            ...
            <h2 class="mt-10  text-2xl font-bold leading-9 tracking-tight text-gray-900">Modifier une modele </h2>
            <form method="POST" action="{{ route('admin.gestionModele.update',$modele->id) }}" class="space-y-6">
                @csrf
                @method('PUT')
                <div>
                ...
                <div>
                    ...
                    <x-text-input id="modele" class="block mt-1 w-full" type="text" name="modele" :value="old('modele') ?? $modele->modele" autofocus autocomplete="modele" />
