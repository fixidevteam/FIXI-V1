          ...
          <div class="flex flex-col md:flex-row gap-5 w-full justify-center md:justify-start">
            ...
            <div class="flex-1 space-y-4">
              ...
              <div>
                ...
                <p class="text-sm text-gray-500">
                  <a  href="{{ $promotion->lien_promotion }}" target="_blank" rel="noopener"><svg class="w-5 h-5 text-gray-500 transition duration-75 hover:text-gray-900" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
